...
public class EditProduit extends BaseForm {
 ...
 //   int id=0;
    ...
    public EditProduit(com.codename1.ui.util.Resources resourceObjectInstance) {        
        getToolbar().setTitleComponent(
                                FlowLayout.encloseRight(
                        new Label("Modifier Produit", "Title")
                ));
        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                {        
                        ...
                        if( ServiceProduit.getInstance().EditProduit(u))
                            Dialog.show("Succes", "Votre produit a été modifié avec succès", new Command("OK"));
                     new ProduitViewFront(resourceObjectInstance).show();       
                    }   
                }
        });
